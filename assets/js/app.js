...
let tab = ['--menuOnOFF', '--menuIcone', '--menubutton', '--menubuttonSeCo', '--iconeOpacity', '--waitLonger', '--waitLonger2', '--waitLonger3', '--waitLonger4', '--waitLonger5', '--waitLonger6', '--waitLonger7'];
let data = ['300px', '220px', '85px', '50px', '100%', '1.1s', '1.2s', '1.3s', '1.4s', '1.5s', '1.6s', '1.7s']
let data2 = ['0px', '-80px', '-215px', '-250px', '0%', '1s', '1s', '1s', '1s', '1s', '1s', '1s',]
